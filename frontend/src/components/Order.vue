...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="OrderNumber" v-model="value.orderNumber"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="Host" v-model="value.host"/>
          </div>
          <div class="grey--text ml-4" v-else>
            Host :  {{value.host }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="GuestAddress" v-model="value.guestAddress"/>
          </div>
          <div class="grey--text ml-4" v-else>
